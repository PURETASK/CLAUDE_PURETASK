...
**Required order:**
1. `B1_core_identity.sql`
2. `B2_booking_lifecycle.sql`
3. `B3_trust_evidence.sql`
4. `B4_cleaner_operations.sql`
5. `B5_money.sql`
6. `B6_platform_operations.sql`
7. `B7_onboarding_verification.sql`
8. `B8_audit_fixes.sql` ← **must run last**
...
The user will provide these 8 SQL files alongside this document:

1. `B1_core_identity.sql` (32 KB)
2. `B2_booking_lifecycle.sql` (39 KB)
3. `B3_trust_evidence.sql` (32 KB)
4. `B4_cleaner_operations.sql` (38 KB)
5. `B5_money.sql` (31 KB)
6. `B6_platform_operations.sql` (29 KB)
7. `B7_onboarding_verification.sql` (25 KB)
8. `B8_audit_fixes.sql` (12 KB)
