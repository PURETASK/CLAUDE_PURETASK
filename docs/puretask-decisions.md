...
**How to read this:** Skim it once end-to-end so you know what's been decided. Come back to specific sections when you have questions about *why* something is set up a particular way.
...
- **Recommendation:** **Conventional commits.** `feat:`, `fix:`, `chore:`, `refactor:`, `docs:`. One sentence body explaining *why*.
