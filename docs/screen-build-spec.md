...
| -------------------------------------------------------------- | ---------------------------------- | ----------------------------------- | -------------- | ------------------------------------ | ----------------------- | ---- |
| Dashboard (next clean, rebook, recurring nudge, recent)        | `customer_dashboard_v1`            | `/app/dashboard` (+ `/app`)         | BUILT          | bookings, recurring                  | Re-skin                 | 2    |
| Browse / cleaner list (filters, new, top, all)                 | `customer_cleaner_list_v3`         | `/app/cleaners`                     | BUILT          | discovery, ZIP                       | Re-skin                 | 2    |
| Cleaner profile (bio, stats, gallery, services, reviews, area) | `customer_cleaner_profile_v1`      | `/app/cleaners/[id]`                | BUILT          | profile, reviews                     | Re-skin                 | 2    |
...
| Active job tracking (live timeline + photos)                   | `customer_active_job_v1`           | `/app/bookings/[id]/tracking`       | BUILT          | verification, photos                 | Re-skin                 | 2    |
| Approve & pay (photo review, approve/dispute)                  | `customer_approve_pay_v1`          | `/app/bookings/[id]`                | BUILT          | `approveBookingAction`               | Re-skin                 | 2    |
...
| Review prompt (stars + tags + tip + favorite)                  | `customer_review_prompt_v1`        | `/app/bookings/[id]/review`         | BUILT          | `submitReviewAction`, `addTipAction` | Extend                  | 2    |
| Tip prompt (standalone)                                        | `customer_tip_prompt_v1`           | `/app/bookings/[id]/tip`            | PARTIAL        | `addTipAction`                       | Re-skin                 | 2    |
