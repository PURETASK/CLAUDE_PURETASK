...
export const CustomerFirstTimeTour = ({ onDone }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-neutral-900/50 p-4 sm:items-center">
      <div className={`w-full max-w-sm rounded-3xl border border-neutral-200 p-8 ${current.bg}`}>
        <div className={`mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full text-3xl ${current.iconBg}`}>
          {current.icon}
        </div>
