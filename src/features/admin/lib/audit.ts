...
export async function writeAdminAction(
  ...
  await supabase.from('admin_actions').insert({
    ...
    before_state: (params.beforeState ??
      null) as Database['public']['Tables']['admin_actions']['Insert']['before_state'],
    after_state: (params.afterState ??
      null) as Database['public']['Tables']['admin_actions']['Insert']['after_state'],
    metadata: (params.metadata ??
      null) as Database['public']['Tables']['admin_actions']['Insert']['metadata'],
  });
}
