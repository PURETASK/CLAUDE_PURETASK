...
const STATE_CONFIG: Record<IDState, { label: string; tone: Tone; desc: string }> = {
  created: {
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-5">
      <div>
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold text-neutral-900">Identity verification</h1>
        </div>
      ...
      <Card elevation={1} className="border border-neutral-200 p-5">
        <h2 className="mb-3 text-base font-semibold text-neutral-900">What you will need</h2>
